...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-06-25 17:50`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cd1feddd-f9cc-489a-9491-bc2c00e0279e.git
$ cd cd1feddd-f9cc-489a-9491-bc2c00e0279e
```
